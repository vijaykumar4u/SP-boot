package com.vijay.app.exception;
...
public class StudentNameNotFoundException extends RuntimeException{
	...
	public StudentNameNotFoundException(String message, Throwable cause, boolean enableSuppression,
	...
	public StudentNameNotFoundException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
